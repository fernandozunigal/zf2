...
return array(
    ...
    "Invalid type given. String expected" => "خطأ في المدخلة. يجب ادخال نص",
    "The input is less than %min% characters long" => "طول '%value%' يجب أن يكون %min% حرف على الأقل",
    "The input is more than %max% characters long" => "طول '%value%' يجب أن يكون %max% كحد أقصى",
);
